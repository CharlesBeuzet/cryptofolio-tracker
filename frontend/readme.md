...
- **SILLAGE** sidebar layout with §1–§4 navigation
...
|-------|---------|-------------|
| `/` | §1 Overview | NAV chart, positions table, allocation donut |
| `/position/:id` | §2 Position detail | Price chart, P&L panel, order history |
| `/fiat-deposits` | §3 On-ramp | Deposits vs NAV chart, deposit ledger |
| `/performance` | §4 Theses | Performance grouped by venue |
